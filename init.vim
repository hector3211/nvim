...
Plug 'https://github.com/MaxMEllon/vim-jsx-pretty' "React syntax highlighting
Plug 'https://github.com/preservim/nerdtree' "NerdTree
Plug 'https://github.com/nvim-telescope/telescope.nvim' "Telescope
Plug 'https://github.com/nvim-lua/plenary.nvim' "Telescope depenency
Plug 'nvim-telescope/telescope-media-files.nvim' "Telescope Media file extension 
Plug 'nvim-lua/popup.nvim' "Telescope Popup
Plug 'https://github.com/tpope/vim-commentary' "Commenting press gcc or gc
...
Plug 'https://github.com/akinsho/bufferline.nvim' "BufferLine
...
nnoremap <C-l> :call CocActionAsync('jumpDefineition')<CR>
...
"BufferLine
nnoremap <silent> [w :BufferLineCycleNext<cr>
